...
<head>
	...
	<link href="https://fonts.googleapis.com/css?family=Lora:400,400i,700,700i&display=swap"
	      rel="stylesheet">
	<link href="https://fonts.googleapis.com/css?family=Abril+Fatface&display=swap"
	      rel="stylesheet">
	
	<link rel="stylesheet"
	      href="{{ URL::asset('css/open-iconic-bootstrap.min.css'); }}">
	<link rel="stylesheet" href="{{ URL::asset('css/animate.css'); }}">
	
	<link rel="stylesheet" href="{{ URL::asset('css/owl.carousel.min.css'); }}">
	<link rel="stylesheet"
	      href="{{ URL::asset('css/owl.theme.default.min.css'); }}">
	...
	<link rel="stylesheet"
	      href="{{ URL::asset('css/bootstrap-datepicker.css'); }}">
	<link rel="stylesheet"
	      href="{{ URL::asset('css/jquery.timepicker.css'); }}">
			...
			<div class="mb-4">
				...
				<form action="#" class="colorlib-subscribe-form">
					<div class="form-group d-flex">
						<div class="icon"><span class="icon-paper-plane"></span>
						</div>
					...
					<div class="col-xl-4 sidebar ftco-animate bg-light pt-5">
						...
						<div class="sidebar-box ftco-animate">
							...
							<div class="block-21 mb-4 d-flex">
								...
								<div class="text">
									<h3 class="heading"><a href="#">Even the
											all-powerful Pointing has no
											control</a></h3>
									<div class="meta">
										<div><a href="#"><span
						...
						<div class="sidebar-box subs-wrap img py-4"
							...
							<p class="mb-4">Far far away, behind the word
								mountains, far from the countries Vokalia</p>
						...
						<div class="sidebar-box ftco-animate">
							...
							<ul class="categories">
								<li><a href="#">Decob14 2018
										<span>(10)</span></a></li>
								<li><a href="#">September 2018 <span>(6)</span></a>
								</li>
								<li><a href="#">August 2018 <span>(8)</span></a>
								</li>
								<li><a href="#">July 2018 <span>(2)</span></a>
								</li>
								<li><a href="#">June 2018 <span>(7)</span></a>
								</li>
								<li><a href="#">May 2018 <span>(5)</span></a>
								</li>
							</ul>
						</div>
